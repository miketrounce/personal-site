...
- **Scoped styles** — CSS written inside a `.astro` file only applies to that
  ...
  rules live in `src/styles/page-layouts.css` and `src/styles/case-study.css`.
...
| Path | Purpose |
|------|---------|
| `src/pages/` | File-based routes: `/`, `/about`, `/how-i-work`, `/case-studies`, `/case-study-1`, `/case-study-2`, `/promoting-your-business`, `/website-options`, and the 404 fallback. |
...
| `src/styles/case-study.css` | Shared shell for the two case-study pages. |
